	...
	<div class="container">
		...
		<table class="table table-hover table-dark" border="1" cell padding="5">
			<thead class="text-center">
				<th scope="row" class="text-center"><h3><i>Category Names</i></h3></th><br><br>
			</thead>
			<tbody>
				<c:forEach items="${catList}" var="cat">
					<tr>
						<td><h4><b style="color:solid coral">${cat.categoryName }</b></h4></td>
						<td><spring:url value="/product/productList/${cat.id}"
								var="updateURL" /> <a class="btn btn-primary"
							href="${updateURL}" role="button">Product List</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
