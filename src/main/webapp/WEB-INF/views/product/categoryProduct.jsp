...
<body class="background1">
	...
	<div class="sidebar">
		<h2>
			<a class="active" href="<spring:url value='/home/index2'/>">Home</a>
		</h2>
		<h2>
			<a href="#flowers">Shop For Flowers</a>
		</h2>

		<h2>
			<a href="#cakes">Shop for Cakes</a>
		</h2>
		<h2>
			<a href="#gifts">Shop For gifts</a>
		</h2>
		<!-- <h2>
	...
	<div style="margin-left: 15%">
		...
		<div class="w3-container w3-teal">
			<h1 class="text-left font-italic" style="color: beige" id="flowers">
				<u>Shop Your Favourites</u>
			</h1>
			<br>
			<div class="row">
				<spring:url value="/customer/cart" var="saveURL" />

				<c:forEach items="${prodList}" var="list">
						<div class="col-sm-6">
							<div class="card" style="width: 60%; height:100%">
								<img class="card-img-top " src="${list.image}" alt="product1"
									style="width: 100%; height:50%">
								<div class="card-body">
									<p class="card-title">${list.productName}
									<p>
									<p class="price">${list.salePrice}<span class="sm-text"></span>
									</p>
									<div class="stars">
										<span class="fa fa-star star-active"></span> <span
											class="fa fa-star star-active"></span> <span
											class="fa fa-star star-active"></span> <span
											class="fa fa-star-o"></span> <span class="fa fa-star-o"></span>
									</div>
									<form:form modelAttribute="citem" action="${saveURL}"
										method="post" cssClass="form">
										<form:input path="products" type="hidden" value="${list.id}" />
										<form:input type="number" path="quantity" min="1" max="10"
											name="selectedQuantity" />
										<form:input path="totalPrice" type="hidden"
											value="${list.salePrice}" />
